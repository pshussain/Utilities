...
public class AdgroupTest {
	...
	public void createAdgroup() throws UnsupportedEncodingException, Exception {
		...
		fbAccount.addAdgroup("1419302888335966", "New Adgroup",
				AdgroupStatus.ACTIVE.getAdgroupStatus(),
				BidType.CPM.getBidType(), "{'CLICKS':150}", null,
				"6021452658331", null,
				Objective.MOBILE_APP_INSTALLS.getObjective(), null, null, null,
				null);
